        ...
        while (k) {
            ...
            switch (choose) {
                ...
                case 5: {
                    ...
                    Collections.sort(productList, CommodityLengthComparator);
                    showProducts(productList);
                    k = wantToContinue();
                    break;
                }
                case 6: {
                    ...
                    Collections.sort(productList, CommodityWidthComparator);
                    showProducts(productList);
                    k = wantToContinue();
                    break;
                }
                case 7: {
                    Comparator<Commodity> CommodityWeigthComparator = new Comparator<Commodity>() {
                        @Override
                        public int compare(Commodity o1, Commodity o2) {
                    ...
                    Collections.sort(productList, CommodityWeigthComparator);
                    showProducts(productList);
                    k = wantToContinue();
                    break;
                }
